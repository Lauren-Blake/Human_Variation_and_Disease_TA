...
\item The probability density for the bivariate normal distribution, incorporates the means of each of the random variables (below written as \textit{X} and \textit{Y} for clarity), the variances of the two random variables, and the correlation coefficient, $\rho$.
